    ...
    return (
      ...
      <div style={{
        ...
        <FormControl className={classes.formControl}>
          <InputLabel htmlFor="name-simple">Enter College/School Name</InputLabel>
          <Input style={{
            width: 800
        ...
        <FormControl className={classes.formControl}>
          ...
          <Input style={{
            width: 300
          }} value={this.state.registrationDeadline} onChange={this.handleChangeDate} />
        </FormControl>
        ...
        onClick={() => {
          ...
          variant="fab" color="primary" aria-label="AddCheckListItem" className={classes.button}>
             <AddIcon />
          </Button>
          <Button style={{
            top: 25
          ...
          onClick={() => {
            ...
            variant="fab" color="secondary" aria-label="AddCheckListItem" className={classes.button}>
               <DeleteIcon />
            </Button>
            ...
            style={{
              top: 25,
              marginLeft: 450
            }} variant="contained" color="primary" size="large" className={classes.button}>
        <SaveIcon />
        Add School
      </Button>
  ...
  variables: {
    ...
    if(this.state.checklistData.length === 0) {
      ...
      this.state.checklistData.forEach(checklist => {
        console.log
        requests.push(axios.post('https://f-connect.herokuapp.com/graphql', {
          query: `
    ...
    return this.state.checklist.map(checklist => {
      return (
        ...
        <FormControl className={classes.formControl}>
          ...
          <Input style={{
            width: 500
          }} value={this.state.checklistData[checklist].name} onChange={this.handleChecklistName.bind(this, checklist)} />
        </FormControl>
        <FormControl className={classes.formControl}>
          <InputLabel htmlFor="name-simple">Enter Date</InputLabel>
          <Input style={{
            width: 250
          }} value={this.state.checklistData[checklist].deadline} onChange={this.handleChecklistDate.bind(this, checklist)} />
        </FormControl>
        </Grid>
      )
    })
